...
# move discretized data to GPU
# TODO: data should be formed on GPU rather than moved
...
G_gpu = G_ellipsoid(qx_gpu, qy_gpu, rp_gpu, re_gpu, theta_gpu, phi_gpu, drho)
# TODO: should be moved to CPU later
G = G_gpu.get() # move from GPU to CPU
...
print("\nStep 2: SAS inversion with true G\n")
xi_opt, b_opt, w_rp_opt, w_re_opt, w_theta_opt, w_phi_opt = tt_optimize(G, dims, I_data, I_data, sigma=0,
