...
Gw_true = cp.tensordot(cp.tensordot(cp.tensordot(cp.tensordot(G, w_l_true, axes=(2,0)), w_r_true, axes=(2,0)), w_theta_true, axes=(2,0)), w_phi_true, axes=(2,0))
print('done.')
...
import numpy as np
Gw_opt = np.tensordot(np.tensordot(np.tensordot(np.tensordot(G, w_l_opt, axes=(2,0)), w_r_opt, axes=(2,0)), w_theta_opt, axes=(2,0)), w_phi_opt, axes=(2,0))
print('done.')
